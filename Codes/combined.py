...
def main(dataset_name):
	...
	trval_concat=pd.concat([trval1,trval2,trval3],axis=1, sort=False, ignore_index=False)

	print(trval_concat.head())
	...
	for i in range(3):
		...
		train(train_X,train_y,num_features[i],num_classes, [100,100,100], (i+1))
	#***************************************************
	...
	train(train2_X,train2_y,num_classes*3,num_classes, [15,15,15], 4)
	#***************************************************************
